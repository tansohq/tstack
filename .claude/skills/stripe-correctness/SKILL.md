...
<!-- Custom Discover→Audit→Report instead of shared REACTIVE_METHODOLOGY:
     code-auditing skills need to grep for the integration surface first,
     not form hypotheses from artifacts. Intentional divergence. -->
