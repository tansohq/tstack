...
<!-- Custom Extract→Audit→Report instead of shared REACTIVE_METHODOLOGY:
     state machine auditing must first extract the implicit machine from code
     before it can be audited. Intentional divergence. -->
